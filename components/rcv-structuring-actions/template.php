...
<div class="field" :class="fieldClass">
    ...
    <mc-tag-list v-if="!hideTags" editable :tags="selectedActions" :labels="actions" classes="agent__background agent__color"></mc-tag-list>
</div>
...
<div class="field" :class="fieldClass">
    ...
    <mc-tag-list v-if="!hideTags" editable :tags="selectedOtherActions" :labels="otherActions" classes="agent__background agent__color"></mc-tag-list>
</div>