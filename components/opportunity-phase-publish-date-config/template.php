...
<div class="col-12">
    <div class="grid-12 opportunity-phase-publish-date-config">
        ...
        <div class="col-12 grid-12" v-if="true">
            ...
            <?php // CulturaViva: segura os pareceres publicados até o resultado final ?>
            <div class="col-12" v-if="phase.evaluationMethodConfiguration && !phase.isAppealPhase && phase.evaluationMethodConfiguration.publishEvaluationDetails">
                <entity-field :entity="phase.evaluationMethodConfiguration" prop="publicarPareceresApenasResultadoFinal" type="checkbox" :autosave="300"></entity-field>
            </div>
            ...
            <?php // CulturaViva: administradores veem os pareceres mesmo sem publicação ?>
            <div class="col-12" v-if="phase.evaluationMethodConfiguration && !phase.isAppealPhase">
                <entity-field :entity="phase.evaluationMethodConfiguration" prop="administradoresVeemPareceres" type="checkbox" :autosave="300"></entity-field>
            </div>
        </div>
    </div>
</div>