...
<div v-if="!phase.isLastPhase" class="opportunity-phases-timeline__box">
    ...
    <div class="opportunity-phases-timeline__status">
        ...
        <p v-if="isUnderAnalysis(registration)"><?= i::__('Em análise') ?></p>
        <p v-else-if="registration.status == 10"><?= i::__('Inscrição selecionada') ?></p>
        <p v-else-if="registration.status == 8"><?= i::__('Inscrição suplente') ?></p>
        <p v-else-if="registration.status == 3"><?= i::__('Inscrição não selecionada') ?></p>
        <p v-else-if="registration.status == 2"><?= i::__('Inscrição inválida') ?></p>
        <p v-else-if="registration.status == 1"><?= i::__('Inscrição enviada') ?></p>
        <p v-else-if="registration.status == 0"><?= i::__('Inscrição não enviada') ?></p>
    </div>
