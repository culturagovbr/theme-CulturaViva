    ...
    <div class="registration-results__card-header">
        ...
        <div>
            <p>
                ...
                <strong :class="consolidatedResultClass(registration.consolidatedResult)">
                    <mc-icon name="circle" :class="consolidatedResultClass(registration.consolidatedResult)"></mc-icon>
                    <template v-if="registration.consolidatedResult === 'valid'">
                        {{registration.score}}
