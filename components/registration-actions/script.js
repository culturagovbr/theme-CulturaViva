app.component('registration-actions', {
    ...
    computed: {
        hasEditableFields() {
            return $MAPAS.config.rcv_registration_actions.hasEditableFields;
        },
    ...
    methods: {
        ...
        async send(modal) {
            ...
            try {
                ...
                if(this.registration.editableFields) {
                    let url = this.registration.agentRelations.coletivo[0].agent.singleUrl;
