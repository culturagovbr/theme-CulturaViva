...
<mc-tab label="<?= i::_e('Dados RFB') ?>" slug="rfb" v-if="entity.currentUserPermissions['@control'] && entity.rcv_rfData">
    <mc-container>
        <main>
            <div class="single-data grid-12" v-if="entity.rcv_rfData">
                <h3 class="single-data__title col-12"><?= i::__("Dados da Receita Federal Brasileira") ?></h3>

                <rcv-rf-data :entity="entity"></rcv-rf-data>
            </div>
        </main>
